...
/* create empty constructor so then we aren't constrained to having to make a product name or
pass some product name,  every time we decide to create a product object.
